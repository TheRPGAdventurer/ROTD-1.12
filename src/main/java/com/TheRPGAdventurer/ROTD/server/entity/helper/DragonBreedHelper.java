...
public class DragonBreedHelper extends DragonHelper {
    ...
    public void getBreedHealth() {
        ...
        if (currentType == EnumDragonBreed.NETHER) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(95.0D);}
        if (currentType == EnumDragonBreed.END) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(100.0D);}
        if (currentType == EnumDragonBreed.GARNET) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(85.0D);}
        if (currentType == EnumDragonBreed.JADE) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(85.0D);}
        if (currentType == EnumDragonBreed.SAPPHIRE) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(85.0D);}
        if (currentType == EnumDragonBreed.RUBY) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(85.0D); }
        if (currentType == EnumDragonBreed.AMETHYST) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(85.0D);}
        if (currentType == EnumDragonBreed.SKELETON) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(65.0D); }
        if (currentType == EnumDragonBreed.WITHER) {dragon.getEntityAttribute(att.MAX_HEALTH).setBaseValue(80.0D);}
    }
