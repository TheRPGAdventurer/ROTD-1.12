...
import com.TheRPGAdventurer.ROTD.server.entity.ai.targeting.EntityAIControlledRangedBreathAttack;
...
public class DragonBrain extends DragonHelper {
    ...
    public void updateAITasks() {
        ...
        if (dragon.isFlying()) {
            tasks.addTask(2, new EntityAIDragonLand(dragon, 1)); // mutex 1
        } else {
            ...
            attackTasks.addTask(1,new EntityAIControlledRangedBreathAttack(dragon, minAttackRange, (minAttackRange + maxAttackRange) / 2, maxAttackRange)); // mutex 1
